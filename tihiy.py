...
is_conditions_button_clicked = False
is_description_button_clicked = False
...
'\nДоставка обсуждается индивидуально🚚', random_id=random_id, keyboard=keyboard)
            elif message == 'условия аренды' and not is_conditions_button_clicked:
...
'\n\nВыберите одно из следующих действий:', random_id=random_id, keyboard=keyboard)
                is_conditions_button_clicked = True
            elif message == 'описание и фото' and not is_description_button_clicked:
                ...
                is_description_button_clicked = True
