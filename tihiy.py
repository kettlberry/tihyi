...
for event in longpoll.listen():
    if event.type == VkEventType.MESSAGE_NEW:
        if event.to_me:
            ...
            if message == 'начать':
                # Отправляем сообщение с клавиатурой и прикрепляем две фотографии
                vk_session_api.messages.send(
                    user_id=id,
                    message='Рад приветствовать тебя в сообществе “ТИХИЙ ГЕНИЙ”'
                    ...
                    random_id=random_id,
                    keyboard=keyboard,
                    attachment='vk1.a.qnbdmOe7uUL5JadRaFqGXlFH_ZiOOgk1cxvLWU7JviM1VDVbATpRzHTYUEWu3BN8ASwiBqlDttgHfdTje1RR2UmRhZcY0EzSbONh4kSiW6y7edZ89oxuIi_ZnybvH7DKg78rEoOKmJkovxgUfKcjq_O0Gc2apPcwLov28iukIbJu2ni_hyTZLVs9VDXinDgnqkwGApXsYkOpoa9ZiiETqA9,vk1.a.qnbdmOe7uUL5JadRaFqGXlFH_ZiOOgk1cxvLWU7JviM1VDVbATpRzHTYUEWu3BN8ASwiBqlDttgHfdTje1RR2UmRhZcY0EzSbONh4kSiW6y7edZ89oxuIi_ZnybvH7DKg78rEoOKmJkovxgUfKcjq_O0Gc2apPcwLov28iukIbJu2ni_hyTZLVs9VDXinDgnqkwGApXsYkOpoa9ZiiETqA1'  # Замените эти значения на реальные ID ваших фотографий
                )
                ...
                vk_session_api.messages.send(
                    user_id=id,
                    message='Качественные магнитные наушники премиального класса. '
                            'В отличие от капсульных, в которые вставляется батарейка, '
                            'здесь установлен аккумулятор, которого хватает более чем на 4 часа разговора. '
                            'Благодаря Bluetooth версии 5.0 качество разговора остаётся идеальным, '
                            'вне зависимости от того, как далеко расположен телефон.  '
                            'Специальная усиливающая антенна позволяет не перебить сигнал наушника в случае, '
                            'если человек сидящий рядом с вами тоже одел наушник.',
                    random_id=random_id,
                    keyboard=keyboard
                )
